...
<section class="page-product-box blockproductscategory products_block">
	<h3 class="productscategory_h3 page-product-heading">{l s='Related Products' mod='productscategory'}</h3>
			...
			{foreach from=$mproducts item=products name=mypLoop}
				<div class="item {if $smarty.foreach.mypLoop.first}active{/if}">
					{foreach from=$products item=product name=products}
						...
						{/if}
							<div class="col-md-{12/$columnspage} col-xs-12 product_block ajax_block_product">
