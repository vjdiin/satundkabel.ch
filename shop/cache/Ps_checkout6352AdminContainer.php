 ...
 */
class Ps_checkout6352AdminContainer extends Container
{
    private $parameters = [];
    private $targetDirs = [];
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.6.1.24', '/var/www/html', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.6.1.24', '/var/www/html');
    }
