<?php /* Smarty version Smarty-3.1.19, created on 2023-12-10 17:58:37
         compiled from "/var/www/html/themes/leomobi/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13020201336575ee3dc26be8-90764290%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0adb72b599af990bf0f524c7c6af4dc4750797cf' => 
    array (
      0 => '/var/www/html/themes/leomobi/modules/blockcart/blockcart.tpl',
      1 => 1702225807,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13020201336575ee3dc26be8-90764290',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6575ee3de25b56_61112070',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6575ee3de25b56_61112070')) {function content_6575ee3de25b56_61112070($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/tools/smarty/plugins/modifier.replace.php';
...
<div class="col-sm-4 col-md-4 pull-right clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
...
" rel="nofollow">
			<span class="title_cart"><?php echo smartyTranslate(array('s'=>'Shopping Cart','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
			...
			<span class="red_color ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>">
				0 <span ><?php echo smartyTranslate(array('s'=>'Item','mod'=>'blockcart'),$_smarty_tpl);?>
