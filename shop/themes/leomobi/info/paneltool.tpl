            ...
            <h4>{l s='Panel Tool'}</h4>
              <form action="" method="post" class="form-horizontal clearfix">
                ...
                <div class="group-input clearfix">
                  <label class="col-sm-3 col-md-3 control-label">{l s='Theme'}</label>		
                ...
                {if $directions}
                <div class="group-input clearfix">
                    <label class="col-sm-3 col-md-3 control-label">{l s='Layout'}</label>
                    <div class="col-sm-9 col-md-9">
                ...
                <div class=" clearfix" style="width:100%">
                  ...
                  <p class="pull-right">
                    ...
                    <a class="btn btn-small" href="{$content_dir}index.php?actreset=?"><span>{l s='Reset'}</span></a>
                  </p>
              </div>
              </form>
          </div>  
