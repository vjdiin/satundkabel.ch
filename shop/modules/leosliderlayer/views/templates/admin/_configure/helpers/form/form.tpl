    ...
    {if $input.type == 'group_button' && $input.id_group}
        <div class="form-group">
            <div class="col-lg-9 col-lg-offset-3">
                ...
                <a class="btn btn-default color_success" href="{$link->getAdminLink('AdminModules')}&configure=leosliderlayer&showsliders=1&id_group={$input.id_group}"><i class="icon-film"></i> {l s='Manages Sliders'}</a>
                <a class="btn btn-default" href="{$exportLink}&id_group={$input.id_group}"><i class="icon-eye-open"></i> {l s='Export Group and sliders'}</a>
