...
<div class="panel-heading">
	...
	<span class="panel-heading-action">
        ...
        <div class="alert alert-info">{l s='Config of Group:'} {$group_title} - <a href="{$link->getAdminLink('AdminModules')}&configure=leosliderlayer&editgroup=1&id_group={$id_group}" alt={l s='Back to group'}>{l s='Back to grop'}</a></div>                    
