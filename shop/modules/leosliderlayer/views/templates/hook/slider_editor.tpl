...
<div class="form-group">
    <div class="col-lg-9 col-lg-offset-3">
        ...
        <a id="btn-preview-slider" class="btn btn-default {if $languages|count > 1}dropdown-toggle {else}slider-preview {/if}color_danger" herf="javascript:void(0);" data-link="{$previewLink}&id_group={$id_group}"><i class="icon-eye-open"></i> {l s='Preview This Slider'}</a>
    </div>
</div>
...
<div class="slider-toolbar">
    ...
    <div class="btn-delete" data-action="delete-layer"><i class="icon-remove"></i> {l s='Delete'}</div>
</div>
</div>
{*editor content*}
<div class="col-lg-11">
