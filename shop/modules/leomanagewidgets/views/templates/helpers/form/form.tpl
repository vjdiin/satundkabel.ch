...
{block name="field"}
	...
	{if $input.type == 'modules_block'}
            ...
            {if isset($moduleList) && count($moduleList) > 0}
                <p class="help-block">{l s='You can select one or more Module.' mod='leomanagewidgets'}</p>
                <table cellspacing="0" cellpadding="0" class="table" style="min-width:40em;">
                    <tr>
                        ...
                        <th>{l s='Name' mod='leomanagewidgets'}</th>
                        <th>{l s='Back-up File' mod='leomanagewidgets'}</th>
                    </tr>
            ...
            <div class="form-group button-wrapper">
                    <div class="col-lg-9 col-lg-offset-3">
                        <button class="button btn btn-success" name="submitBackup" id="module_form_submit_btn" type="submit">
                                 {l s="Back-up" mod='leomanagewidgets'}
                        </button>
                        <button class="button btn btn-danger" name="submitRestore" data-confirm="{l s='Are you sure you want to restore back-up file?' mod='leomanagewidgets'}" id="module_form_submit_btn" type="submit">
                                 {l s="Restore Back-up File" mod='leomanagewidgets'}
                        </button>
                        
                        <button class="button btn btn-success" name="submitSample" id="module_form_submit_btn" type="submit">
                                 {l s="Export Sample Data" mod='leomanagewidgets'}
                        </button>
                        <button class="button btn btn-danger" name="submitImport" data-confirm="{l s='Are you sure you want to restore data sample of template. You will lost all data of module' mod='leomanagewidgets'}" id="module_form_submit_btn" type="submit">
                                 {l s="Restore Sample Data" mod='leomanagewidgets'}
                        </button>
                        <p class="help-block">{l s='Data Sample is only for theme developer' mod='leomanagewidgets'}</p>
                    </div>
            </div>
            <div class="form-group">
                <div class="col-lg-9 col-lg-offset-3">
                    <div class="alert alert-info">
                        {l s='With restore function, you will lost all data of module in site for all shop' mod='leomanagewidgets'}
                        <hr>
                        {l s='You should back-up before do any thing' mod='leomanagewidgets'}
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="col-lg-9 col-lg-offset-3">
                    <button class="button btn btn-success" name="submitExportDBStruct" id="module_form_submit_btn" type="submit">
                            {l s="Export Data Struct" mod='leomanagewidgets'}
                    </button>
                    <p class="help-block">{l s='You can download file in modules/leotemcp/install. This function is only for theme developer' mod='leomanagewidgets'}</p>
                </div>
            </div>
            <script type="text/javascript">
