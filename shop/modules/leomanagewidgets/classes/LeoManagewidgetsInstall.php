...
if( !class_exists("LeoManagewidgetsInstall") ){
     ...
     */
	        ...
	        foreach ($columns as $column){
	            ...
	            if($newColumn->add()){
	                ...
	                if($column["key_widget"] != 0){
	                    ...
	                    if ($newColumn->params) {
	                        $myParam = Tools::jsonDecode(base64_decode($newColumn->params), true);
	                        if($myParam)
	    ...
	    public static function installModuleTab($module_name, $title, $class_sfx = '', $parent = '') {
	        $class = 'Admin' . ucfirst($module_name) . ucfirst($class_sfx);
   		...
   		public static function uninstallModuleTab($module_name, $class_sfx = '') {
	        $tabClass = 'Admin' . ucfirst($module_name) . ucfirst($class_sfx);
